function PlanarDoubleRWPeriodicMoco(fName,finalAngle)
...
problem.setTimeBounds(MocoInitialBounds(0.),MocoFinalBounds(0.2, 1));
...
solver.setGuessFile([fName_prefix,'_CycleGuess.sto'])

solution = study.solve();

solution.unseal();
solution.write([fName_prefix,'_2Dcycle.sto']);
disp(['Solution written to ',fName_prefix,'_2Dcycle.sto'])
